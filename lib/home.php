...
<section class="sholder">
	<ul class="slajder">
		<li>
			...
			<a href="?q=home">
				<img src="media/png/engine_up.png" />
				<span>ng1np</span>
			</a>
		</li>
                	<li>
			<input type="radio" id="s2" name="num" checked="true" />
			<label for="s2">2</label>
			<a href="?q=home">
				<img src="media/png/wlogo.png" />
		...
		<li>
			...
			<a href="?q=home">
				<img src="media/png/ng1np.png" />
				<span>&reg;ng1np^v.1.2</span>
			</a>
		</li>
